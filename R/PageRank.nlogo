...
to setup
  ...
  [ create-network-example-1 ] [
    ...
    [ create-network-example-2 ] [
      ifelse network-choice = "Tutorial Network"
      [ create-tutorial-network ] [
        ifelse network-choice = "Tutorial Network 2"
        [create-tutorial-network2 ] [
  ...
  if network-choice != "Tutorial Network" and network-choice != "Tutorial Network 2"[
...
to create-tutorial-network
  create-pages 9
  ask page 0 [ die ]
  ask page 1 [create-links-from (turtle-set page 4 page 5 page 6 page 7 page 8 )]
  ask page 2 [create-link-from page 1]
  ask page 3 [create-link-from page 1]
  ask page 4 [create-link-from page 2]
  ask page 5 [create-link-from page 2]
  ask page 6 [create-link-from page 3]
  ask page 7 [create-link-from page 3]
  ask page 8 [create-links-from (turtle-set page 4 page 5 )]
  ask page 1 [setxy 2 9]
  ask page 2 [setxy -5 -2]
  ask page 3 [setxy 5 -0.7]
  ask page 4 [setxy -9 -0.7]
  ask page 5 [setxy -3 -5]
  ask page 6 [setxy 3 -5.4]
  ask page 7 [setxy 9 -1.7]
  ask page 8 [setxy -2.5 -9]
end


to create-tutorial-network2
  create-pages 9
  ask page 0 [ die ]
  ask page 1 [create-links-from (turtle-set page 4 page 5 page 8 )]
  ask page 2 [create-link-from page 1]
  ask page 3 [create-link-from page 1]
  ask page 4 [create-link-from page 2]
  ask page 5 [create-link-from page 2]
  ask page 6 [create-links-from (turtle-set page 3 page 7)]
  ask page 7 [create-links-from (turtle-set page 3 page 6)]
  ask page 8 [create-links-from (turtle-set page 4 page 5 )]
  ask page 1 [setxy 2 9]
  ask page 2 [setxy -5 -2]
  ask page 3 [setxy 5 -0.7]
...
to create-network-example-1
  create-pages 11 [setxy random-xcor random-ycor]
...
to create-network-example-2
  create-pages 8 [setxy random-xcor random-ycor]
  ask page 0 [ die ]
  ask page 1 [ set color blue create-links-from (turtle-set page 2 page 3 page 5 page 6) ]
  ask page 2 [ set color red create-links-from (turtle-set page 1 page 3 page 4) ]
  ask page 3 [ set color green create-links-from (turtle-set page 1 page 4 page 5) ]
  ask page 4 [ set color yellow create-links-from (turtle-set page 1 page 5) ]
  ask page 5 [ set color orange create-links-from (turtle-set page 1 page 4 page 6 page 7) ]
  ask page 6 [ set color black create-links-from (turtle-set page 5) ]
  ask page 7 [ set color violet create-links-from (turtle-set page 1) ]
end
...
; Copyright 2009 Uri Wilensky and somewhat expanded by Roger Leenders in 2020.
...
network-choice
network-choice
"Tutorial Network" "Tutorial Network 2" "Example 1" "Example 2" "Preferential Attachment"
0
...
PENS
"default" 1.0 1 -16777216 true "" "plot-pen-reset\nplot count pages with [rank < .1]\nplot count pages with [rank >= .1 and rank < .2]\nplot count pages with [rank >= .2 and rank < .3]\nplot count pages with [rank >= .3 and rank < .4]\nplot count pages with [rank >= .4 and rank < .5]\nplot count pages with [rank >= .5 and rank < .6]\nplot count pages with [rank >= .6 and rank < .7]\nplot count pages with [rank >= .7 and rank < .8]\nplot count pages with [rank >= .8 and rank < .9]\nplot count pages with [rank >= .9]"
...
This model is Copyright 2009 Uri Wilensky and somewhat expanded by Roger Leenders in 2020.
